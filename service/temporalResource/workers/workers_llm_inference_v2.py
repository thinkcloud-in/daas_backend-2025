...
from service.temporalResource.workflows.workflows_llm_inference_v2 import CreateMultiNodeLLMWorkflow, PoolVMActionWorkflow
...
async def llm_inference_v2_worker():
    ...
    worker = Worker(
        ...
        workflows=[CreateMultiNodeLLMWorkflow, PoolVMActionWorkflow],
        activities=[
