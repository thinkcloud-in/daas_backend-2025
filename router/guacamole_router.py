...
@guacamole_router.get("/vamanit_session_reports/{start_date}/{end_date}", response_model=APIResponse[Any])
...
@guacamole_router.get("/vamanit_allusers/{start_date}/{end_date}", response_model=APIResponse[Any])
...
@guacamole_router.get("/vamanit_session_reports/{start_date}/{end_date}/{username}", response_model=APIResponse[Any])
...
@guacamole_router.get("/day_reports/{start_date}/{end_date}", response_model=APIResponse[Any])
async def day_reports(start_date: str, end_date: str):
    return await guacamole_controller.get_day_reports(start_date, end_date)

@guacamole_router.get("/day_reports/{start_date}/{end_date}/{username}", response_model=APIResponse[Any])
...
@guacamole_router.get("/reports/{report_type}", response_model=APIResponse[Any])
...
@guacamole_router.get("/total_durations_within_range/{start_date}/{end_date}", response_model=APIResponse[Any])
...
@guacamole_router.get("/total_durations_within_range/{start_date}/{end_date}/{user}", response_model=APIResponse[Any])
...
async def get_client_roles():
    return await guacamole_controller.get_client_roles()
...
async def delete_role(role_name: str):
    return await guacamole_controller.delete_role(role_name)

@guacamole_router.post("/submit_role_components")
async def submit_role_components(request: RoleComponentSubmitRequest):
    return await guacamole_controller.submit_role_components(request)
...
async def get_user_permissions(username: str):
    return await guacamole_controller.get_user_permissions(username)
