...
from models.llm_inference_v2_model import LLMInferenceJobCreate, LLMInferenceJobUpdate
...
def list_llm_inference_jobs(db: Session = Depends(get_db)):
    return llm_inference_v2_controller.list_llm_inference_jobs(db)
